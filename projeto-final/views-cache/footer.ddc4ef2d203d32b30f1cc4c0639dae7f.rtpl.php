<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/2018/marco/php7/projeto-final/res/site/js/owl.carousel.min.js"></script>
    <script src="/2018/marco/php7/projeto-final/res/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/2018/marco/php7/projeto-final/res/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/2018/marco/php7/projeto-final/res/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/2018/marco/php7/projeto-final/res/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/2018/marco/php7/projeto-final/res/site/js/script.slider.js"></script>
  </body>
</html>